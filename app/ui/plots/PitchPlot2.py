...
from app.modules.pitch.Yin2 import Pitch
import os
import json
import sys
...
class PitchPlot(QWidget):
    def __init__(self):
        ...
        self.colors = {
            ...
            'staff_line': '#363636',  # Dark Gray for staff lines
        }
        self.midi_config = {
    ...
    def plot_pitches(self, pitches: list[Pitch]):
        ...
        self.pitches = pg.ScatterPlotItem(
            ...
            y=[freq_to_midi(pitch.frequency) for pitch in pitches],
            size=5,
            pen=None,
            brush=brushes,
            name='Pitch'
...
class RunPitchPlot:
    def __init__(self, app=None, midi_data: MidiData=None, pitches: list[Pitch]=None):
        import sys
